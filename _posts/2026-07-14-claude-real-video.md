...
description: '장면 전환을 인식해 의미 있는 프레임만 뽑고 오디오 트랜스크립트와 함께 LLM이 읽을 수 있게 만들어주는 로컬 실행 도구 claude-real-video 정리.'
---
...
- [headroom-context-compression](/posts/headroom-context-compression/) — LLM에 도달하기 전 컨텍스트를 줄여 비용을 아끼는 접근(더 적은 프레임 = 싼 컨텍스트)
- [prompting-claude-fable-5](/posts/prompting-claude-fable-5/) — 밀도 높은 기술 이미지·스크린샷을 해석하는 비전 능력
