...
## 관련 노트
- [2026-07-05](/posts/daily-2026-07-05/) — API가 없는 상황에서 MSW mock 우선 개발 전략을 실제로 채택한 일지
- [Frontend 공부하기](/posts/frontend-study/) — 백엔드 API가 준비되기 전 프론트엔드 개발에 mock을 쓰는 실전 맥락을 정리한 노트
