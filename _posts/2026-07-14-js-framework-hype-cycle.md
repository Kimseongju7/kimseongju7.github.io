...
description: '2017년부터 2026년까지 매년 "이 프레임워크가 미래다"가 반복되어 온 JS 생태계의 유행 사이클을 풍자하며, 프레임워크를 쫓아다니지 말고 웹의 기본기를 먼저 배우라는 트윗이다.'
---
...
- 웹의 기본을 먼저 배워라:
  - JavaScript, TypeScript, [DOM](/posts/dom/), [CSR](/posts/csr/), [SSR](/posts/ssr/), ISG 등
...
- [nextjs-16-3-turbopack](/posts/nextjs-16-3-turbopack/) — 연대기 속 Next.js의 최신 버전에서 실제로 무엇이 바뀌는지
- [메타프레임워크](/posts/meta-framework/) — Next.js·Remix·Astro·TanStack을 아우르는 메타프레임워크 개념
- [Frontend 공부하기](/posts/frontend-study/) — "도구가 아니라 기본기부터"라는 조언과 이어지는 프론트엔드 학습 노트
