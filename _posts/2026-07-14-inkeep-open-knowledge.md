...
description: 'OpenKnowledge는 Claude, Codex 등 여러 하네스와 통합되는 아름다운 마크다운 에디터다. 지식 베이스, LLM 위키, 스펙, 노트를 위한 도구이며 프라이빗하고 로컬에서 동작하며 무료다.'
---
...
- [harness-engineering-codex](/posts/harness-engineering-codex/) — 에이전트가 읽는 리포지터리 지식 기록 시스템과 통하는 문제의식
- [code-review-graph](/posts/code-review-graph/) — 로컬 MCP 코드 지능 그래프(Obsidian 내보내기 지원)
