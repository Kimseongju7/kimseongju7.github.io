...
description: 'Ouroboros는 "Stop prompting. Start specifying."를 내건 AI 코딩용 Agent OS로, 임기응변식 프롬프팅을 인터뷰 → 결정화 → 실행 → 평가 → 진화의 명세 우선 워크플로로 대체하는 로컬 우선 런타임 계층이다.'
---
...
같은 프로젝트의 한국어 README 정리: [ouroboros-readme-ko](/posts/ouroboros-readme-ko/)
