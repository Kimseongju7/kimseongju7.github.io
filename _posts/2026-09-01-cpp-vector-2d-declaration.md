...
categories: [학습, 용어]
tags: [c++, vector, 코딩테스트, stl, cpp]
description: 'vector<vector<int>> v(행수, vector<int>(열수, 초기값)) — "행 벡터를 행수개 만드는데, 각 행은 열수짜리 벡터로 채운다"는 뜻의 C++ 2차원 배열 크기 사전 선언 문법. vector…'
---
## 한 줄 정의
...
- [2차원 슬라이딩 윈도우](/posts/two-dimensional-sliding-window/)
