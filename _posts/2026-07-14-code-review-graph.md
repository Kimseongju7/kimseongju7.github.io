...
description: 'Tree-sitter로 코드베이스 구조를 그래프화해 AI 코딩 도구에 필요한 파일만 넘기는 로컬 우선 코드 지능 그래프, tirth8205/code-review-graph 정리.'
---
...
- [zilliz-claude-context](/posts/zilliz-claude-context/) — AI 코딩용 시맨틱 코드검색 MCP(비슷한 컨텍스트 절감 접근)
- [harness-engineering-codex](/posts/harness-engineering-codex/) — 린터·구조 테스트로 에이전트 가독성을 기계적으로 강제
