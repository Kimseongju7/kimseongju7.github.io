...
- [[ouroboros-agent-os]] — 명세 우선 워크플로를 얹은 Agent OS
- [[learn-claude-code-bash-is-all-you-need]] — 최소 나노 에이전트 하네스 관점
- [[headroom-context-compression]] — Auto-Compact와 맞닿은 컨텍스트 압축 레이어
- [[harness-engineering-codex]] — 하네스가 에이전트의 환경·피드백 루프를 만든다는 하네스 엔지니어링 관점의 원전 격 글
