...
- **쉬운 시작과 [[온디맨드]] 확장** — 로컬 모드로 몇 분 만에 시작하고, 필요한 만큼 빠르게 확장.
...
- [[브랜치, 분기의 정책 고민]] — 브랜칭 전략을 고민한 노트와 이어지는 버전 관리 주제
- [[zilliz-claude-context]] — 머클 트리 기반 증분 인덱싱을 쓰는 또 다른 사례(콘텐츠 주소·변경분만 처리)
