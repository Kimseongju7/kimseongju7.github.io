...
- [[gpt-5-6-sol-in-claude-code]] — 이 플러그인(루트 A)으로 Claude Code 안에서 GPT-5.6 Sol을 리뷰어로 붙이는 실전 절차
- [[harness-engineering-codex]] — Codex를 하네스 관점에서 다루는 배경
- [[codex-changelog]] — Codex CLI 릴리스·기능 변화 추적
- [[codex-top-6-skills]] — Codex에서 함께 쓰기 좋은 스킬 모음
