...
slug: headroom-context-compression
publish: true
---
...
- [[bytedance-deer-flow]] — 요약·컴팩션으로 컨텍스트 윈도를 관리하는 슈퍼 에이전트 하네스
- [[hkuds-openharness]] — Auto-Compact로 멀티데이 세션 컨텍스트를 압축하는 하네스
- [[claude-real-video]] — 더 적고 의미 있는 프레임으로 컨텍스트 비용을 낮추는 영상 도구
- [[claude-code-model-and-effort]] — Headroom의 Effort routing이 조절하는 사고 깊이(effort) 개념을 다루는 글
