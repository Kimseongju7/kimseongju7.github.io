...
slug: claude-code-multi-agent-sessions
publish: true
---
...
- [[learn-claude-code-bash-is-all-you-need]] — 서브에이전트 격리·컨텍스트 관리 같은 멀티에이전트 하네스 메커니즘을 0부터 구현하며 설명
- [[sakana-fugu]] — 멀티에이전트 오케스트레이션을 API로 다루는 또 다른 사례
- [[art-of-loop-engineering]] — 코디네이터가 에이전트를 반복 호출하는 에이전트 루프의 설계 관점
