...
3. **[[프로비저닝]]된 처리량** — 모델 단위(MU)를 1개월 또는 6개월 약정으로 구매해 일정 처리량을 보장받는다.
...
- [[온디맨드]] — Module 4 추론 모드 중 요청 즉시 응답하고 쓴 만큼 과금하는 방식
- [[프로비저닝]] — Module 4의 "프로비저닝된 처리량"이 미리 자원을 약정·확보하는 방식의 기반 개념
