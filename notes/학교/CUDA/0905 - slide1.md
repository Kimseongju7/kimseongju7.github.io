...
![[Pasted image 20260905151853.png]]
...
![[Pasted image 20260911235134.png]]
...
출력이 메모리일 필요는 없다. `discard_iterator`와 `transform_output_iterator`가 그 예다 (슬라이드 106, 111). → [[Thrust 개요#4. Iterators]]
...
> 종류별 목록과 예제는 [[Thrust 개요#4. Iterators]]
...
![[Pasted image 20260912002213.png]]
...
Thrust는 모든 fancy iterator에 make_ 함수를 제공한다 → [[Thrust 개요#4. Iterators]]
...
![[Pasted image 20260912010442.png]]

좌측 우측 값이 필요할 경우

![[Pasted image 20260912010500.png]]

상하 값이 필요할 경우

![[Pasted image 20260912010509.png]]

현재 값이 필요할 경우

![[Pasted image 20260912010521.png]]
...
![[Pasted image 20260912030436.png]]
